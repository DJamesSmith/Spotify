...
class PlaylistViewController: UIViewController {
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Remove", style: .destructive, handler: { [weak self] _ in
            ...
            APICaller.shared.removeTrackFromPlayist(track: trackToDelete, playlist: strongSelf.playlist) { success in
                DispatchQueue.main.async {
                    if success {
//                        print("Removed")
...
//        let vc = UIActivityViewController(activityItems: ["Checkout this cool playlist I found"], applicationActivities: [])
